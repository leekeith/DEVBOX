		...
		<div id="form" class="left">
			<?php if($wiz_stage==0){ ?>
				<form method="post" name="setup1">
					...
					<br>
						...
						<select disabled="true" id="template" name="template" size="5" style="vertical-align:top" onclick="setProgStuff()">
			...
			<?php }else if($wiz_stage==1){ ?>
				<form method="post" name="setup2">
					<div id="fields">
					<br><label for="outline">Outline your program (one step per line):</label><textarea style="resize:none;float:right;width:400px;" rows="19" id="outline" name="outline" onkeypress="updateOutline(event)"></textarea><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
				</div>
				<div id="buttons" style="float:right">
